...
public class FirebaseAuthenticationFailureHandler {
    ...
    private String translateAuthException(
            AuthenticationException exception, HttpServletRequest request)
            throws JsonProcessingException {
        AuthErrorResponse.AuthErrorResponseBuilder errorResponseBuilder =
        ...
        if (nestedException != null) errorResponseBuilder.details(nestedException.getMessage());
