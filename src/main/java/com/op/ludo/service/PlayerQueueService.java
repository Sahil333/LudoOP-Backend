...
public class PlayerQueueService {
    ...
    // TODO: if players are removed from the queue and error happens either deleting in queue repo
    // or
    //  creating board data will become inconsistent that the players are still in queue table but
    // not
    // in the queue
    //  model need a transactional solution for this problem accounting for any failure at any
    // point.
